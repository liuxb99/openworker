...
func TestValidateAIOpenSeesWorkspace(t *testing.T) {
	...
	runtime:=AIOpenSeesRuntimeState{SchemaVersion:AIOpenSeesRuntimeSchema,Ready:true,Generation:generation,ConfigPath:configPath,CatalogRoot:catalog,EntryCount:3,SnapshotSHA256:snapshot,SnapshotValid:true}
	...
	receipt:=AIOpenSeesOperatorEvidence{SchemaVersion:AIOpenSeesReceiptSchema,CapabilityID:AIOpenSeesCapabilityID,Repository:AIOpenSeesRepository,CommitSHA:"0123456789abcdef0123456789abcdef01234567",RunID:"123",RunAttempt:"1",AssignedHostname:AIOpenSeesHost,MCTPath:mctPath,MCTSHA256:mctSHA,RuntimeConfig:configPath,RuntimeConfigSHA256:testHash(configData),AuthorityGeneration:generation,AuthorityCatalogRoot:catalog,AuthorityEntryCount:3,AuthoritySnapshotSHA256:snapshot,OpenSeesExecutable:exePath,OpenSeesExecutableSHA256:testHash(exeData),Solver:"OpenSees",SolverVersion:"OpenSees 3.7.1",SolverRawExitCode:0,Workspace:root,Status:"complete",Artifacts:artifacts}
