...
const (
	...
	AIOpenSeesHost          = "O87"
	AIOpenSeesResultSchema  = "ai-opensees/analysis-result/v0.5"
	AIOpenSeesReceiptSchema = "ai-opensees/operator-evidence/v0.2"
...
type AIOpenSeesOperatorEvidence struct {
	SchemaVersion string `json:"schema_version"`; CapabilityID string `json:"capability_id"`; Repository string `json:"repository"`; CommitSHA string `json:"commit_sha"`; RunID string `json:"run_id"`; RunAttempt string `json:"run_attempt"`; AssignedHostname string `json:"assigned_hostname"`; MCTPath string `json:"mct_path"`; MCTSHA256 string `json:"mct_sha256"`; RuntimeConfig string `json:"runtime_config"`; AuthorityGeneration int64 `json:"authority_generation"`; AuthorityCatalogRoot string `json:"authority_catalog_root"`; AuthorityEntryCount int `json:"authority_entry_count"`; OpenSeesExecutable string `json:"opensees_executable"`; Workspace string `json:"workspace"`; Status string `json:"status"`; Artifacts []AIOpenSeesArtifact `json:"artifacts"`
}
type AIOpenSeesAnalysisResult struct {
	SchemaVersion string `json:"schema_version"`; Status string `json:"status"`; SourceSHA256 string `json:"source_sha256"`; AuthorityRuntimeUsed bool `json:"authority_runtime_used"`; AuthorityGeneration int64 `json:"authority_generation"`; AuthorityCatalogRoot string `json:"authority_catalog_root"`; AuthorityEntryCount int `json:"authority_entry_count"`; GeometryJSONPath string `json:"geometry_json_path"`; GeometryJSONSHA256 string `json:"geometry_json_sha256"`; DeformedOBJPath string `json:"deformed_obj_path"`; DeformedOBJSHA256 string `json:"deformed_obj_sha256"`; DeformationSVGPath string `json:"deformation_svg_path"`; DeformationSVGSHA256 string `json:"deformation_svg_sha256"`; DisplacementCSVPath string `json:"displacement_csv_path"`; DisplacementCSVSHA256 string `json:"displacement_csv_sha256"`; ReactionCSVPath string `json:"reaction_csv_path"`; ReactionCSVSHA256 string `json:"reaction_csv_sha256"`
}
type AIOpenSeesRuntimeState struct { SchemaVersion string `json:"schema_version"`; Ready bool `json:"ready"`; Generation int64 `json:"generation"`; CatalogRoot string `json:"catalog_root"`; EntryCount int `json:"entry_count"`; SnapshotValid bool `json:"snapshot_valid"` }
type AIOpenSeesEvidenceReport struct { SchemaVersion string `json:"schema_version"`; Accepted bool `json:"accepted"`; Workspace string `json:"workspace"`; AssignedHostname string `json:"assigned_hostname,omitempty"`; RunID string `json:"run_id,omitempty"`; AuthorityGeneration int64 `json:"authority_generation,omitempty"`; VerifiedArtifacts int `json:"verified_artifacts"`; Blockers []string `json:"blockers"` }
...
func ValidateAIOpenSeesWorkspace(workspace string) AIOpenSeesEvidenceReport {
	report:=AIOpenSeesEvidenceReport{SchemaVersion:"openworker/ai-opensees-evidence-report/v0.2",Workspace:filepath.Clean(workspace),Blockers:[]string{}}
