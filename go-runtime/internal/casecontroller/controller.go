...
func Bootstrap(caseID,machine,workspaceRoot,manifestPath,specPath string)(BootstrapResult,error){
    if !supportedCaseID(caseID){return BootstrapResult{},fmt.Errorf("unsupported case %q",caseID)}
...
func supportedCaseID(caseID string)bool{switch strings.TrimSpace(caseID){case "0004","0005":return true;default:return false}}
