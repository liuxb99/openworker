...
$init=Invoke-MCP 1 'initialize' ([ordered]@{protocolVersion='2025-11-25';capabilities=@{};clientInfo=[ordered]@{name='openworker-local-verifier';version='1.0'}});if([string]$init.result.serverInfo.name-ne'openworker-opencode-bridge'){throw 'MCP initialize identity mismatch'}
