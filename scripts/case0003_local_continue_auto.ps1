...
if(-not(Test-Path -LiteralPath $imageryRecorder -PathType Leaf)){throw "Case 0003 imagery acceptance recorder missing: $imageryRecorder"}
...
$resolved=[ordered]@{
  schema='openworker/case0003-root-resolution/v5';case_id='0003';machine=$Machine;source='explicit>openworker-inventory>environment';
