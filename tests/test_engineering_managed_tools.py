...
class FakeClient:
    ...
    def _required_id(self,value,field): return value
    def _object(self,method,path,payload=None):
...
def test_managed_flow_tool_requires_approval_and_delegates_to_os():
    ...
    assert client.calls[0][1]=="/api/v1/jobs/j1/flows/rc-column"
